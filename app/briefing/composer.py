...
_SYSTEM_PROMPT = (
    ...
    "       (blank line)\n"
    "       💡 <i>Why it matters — one sentence on practical impact or implication for AI practitioners.</i>\n"
    "       (blank line)\n"
    "       🔗 <a href=\"URL\">Read Paper</a>  (use 'Read Paper' for arXiv, 'Read Post' for blogs)\n"
    "     Close with </blockquote> immediately after the 🔗 line. "
    "Do NOT use a nested <blockquote> inside — the 💡 line is plain italic text, not a blockquote. "
    "Do NOT output the literal text '(blank line)' — just output the blank line itself.\n"
